...
#define MOB_LOCK_ON_EQUIP		(1<<7)	// Lock this item to the mob that equips it up until permadeath
#define NO_CRYO_STORE			(1<<8) // This item deletes itself when put in cryo storage
#define ITEM_OVERRIDE_NORTHFACE	(1<<9) // For backpacks if they should have unique layering functions
