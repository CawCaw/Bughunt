/mob/living/carbon/human/emote(var/act,var/m_type=1,var/message = null, player_caused)
	...
	switch(act)
		...
		if ("tail")
			if (has_species(src,"Monkey") || has_species(src,"Yiren") || has_species(src,"Neaera") || has_species(src,"Farwa") || has_species(src,"Stok"))
		...
		if("chimper")
			...
			if(has_species(src,"Monkey") && !recent_audio_emote || !player_caused)//cooldown only affect emote generated by the player
				if(has_species(src,"Monkey"))
