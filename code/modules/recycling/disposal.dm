...
/obj/structure/disposalholder/proc/init(var/obj/structure/machinery/disposal/D)
...
/obj/structure/disposalholder/proc/start(var/obj/structure/machinery/disposal/D)
