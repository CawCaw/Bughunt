...
#define SS_INIT_OBJECTIVES        -30
#define SS_INIT_MAPVIEW           -31
#define SS_INIT_LOBBYART          -32
#define SS_INIT_STATPANELS			  -33
#define SS_INIT_CHAT              -34 //Should be last to ensure chat remains smooth during init.
