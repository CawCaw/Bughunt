...
var/list/DEFAULT_NEXT_MAP_CANDIDATES = list(MAP_LV_624)
var/list/NOTVOTABLE_MAPS = list()
...
/proc/setup_ammo()
	var/list/blacklist = list(/datum/ammo/energy, /datum/ammo/bullet/shotgun, /datum/ammo/xeno)
