...
GLOBAL_LIST_INIT(frozen_items, list(SQUAD_NAME_1 = list(), SQUAD_NAME_2 = list(), SQUAD_NAME_3 = list(), SQUAD_NAME_4 = list(), "MP" = list(), "REQ" = list(), "Eng" = list(), "Med" = list()))
...
/obj/structure/machinery/cryopod/proc/despawn_occupant()
	...
	item_loop:
		for(var/obj/item/W in items)
			if(((W.flags_inventory & CANTSTRIP) || (W.flags_item & NODROP) || (W.flags_item & NO_CRYO_STORE))) //We don't keep donor items, undroppable/unremovable items, and specifically filtered items
